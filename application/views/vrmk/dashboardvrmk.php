  ...
  <div class="row">
    <div class="ui cards">
      <div class="card">
        ...
        <a href=<?php echo base_url('verifikator/list'); ?> class="ui bottom attached button" style="background-color:teal;">
      ...
      <!-- <div class="card">
        <div class="content">
          <div class="header">Submit Proposal Tugas Akhir</div>
          <div class="description">
      ...
      <div class="card">
        <div class="content">
          <div class="header">Manage Proposal Tugas Akhir</div>
          <div class="description">
